...
namespace UnityEngine.XR.Interaction.Toolkit.AffordanceSystem.Rendering
{
    ...
    public class MaterialPropertyBlockHelperV2 : MaterialHelperBase
    {
        ...
        protected void LateUpdate()
        {
            ...
            rendererTarget.SetPropertyBlock(m_PropertyBlock);
            m_IsDirty = false;
        }
        ...
        protected override void Initialize()
        {
            ...
            rendererTarget.GetPropertyBlock(m_PropertyBlock);
        }
    }
}
