...
namespace UnityEngine.XR.Interaction.Toolkit.AffordanceSystem.Receiver.Rendering
{
    ...
    [RequireComponent(typeof(MaterialPropertyBlockHelperV2))]
    public class ColorMaterialPropertyAffordanceReceiver : ColorAffordanceReceiver
    {
        ...
        MaterialPropertyBlockHelperV2 m_MaterialPropertyBlockHelper;

        /// <summary>
        /// Material Property Block Helper component reference used to set material properties.
        /// </summary>
        public MaterialPropertyBlockHelperV2 materialPropertyBlockHelper
        {
        ...
        protected void OnValidate()
        {
            if (m_MaterialPropertyBlockHelper == null)
                m_MaterialPropertyBlockHelper = GetComponent<MaterialPropertyBlockHelperV2>();
        }
